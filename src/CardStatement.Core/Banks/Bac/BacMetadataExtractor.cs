...
public sealed partial class BacMetadataExtractor
{
    ...
    public BacStatementMetadata Extract(IReadOnlyList<PdfWord> words)
    {
        ...
        return new BacStatementMetadata(cardType, masked, period);
    }
...
public sealed record BacStatementMetadata(string CardType, string MaskedAccount, StatementPeriod Period);
